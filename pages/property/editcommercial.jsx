...
import { editCommercial } from '../../store/properties/slice';
...
class EditCommercial extends Component {
    constructor(props) {
        super(props);
                ...
                <div className="ps-my-account">
                    <div className="container">
                        ...
                        <Form
                            ...
                            onFinish={this.handleeditCommercialsubmit.bind(this)}>

                            <div className="grid-container">
                                <div className="item1"><h1>Edit Commercial Property</h1></div>
...
export default connect(mapStateToProps)(EditCommercial);
