...
class ResidentialCards extends Component {
    constructor(props) {
        super(props);
    }
        ...
        return (
            <Card style={{width:'100rem', padding:"10px"}}>
                ...
                <Card.Body>
                    ...
                    <Card.Text>
                        {property.area} sqft {property.beds} <BiBed /> {property.baths}<BiBath />
                    </Card.Text>
                    <Card.Text>
                        {property.furnished.toString()}|{property.property_type_id}|{property.status_id}|{property.city_id}| {property.location}
                    </Card.Text>
                    <Link href={{pathname:"/property/editresidential" ,query:{ property: JSON.stringify(property) } }}><Button variant="primary">EDIT</Button></Link> 
